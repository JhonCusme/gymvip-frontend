...
// ============================================================
// CUMPLEAÑEROS RECEPCIÓN
// ============================================================
export function ReceptionBirthdaysPage() {
  const { gym } = useAuth();
  const primaryColor = gym?.primaryColor || '#E85D04';
  ...
  useEffect(() => {
    setLoading(true);
    receptionAPI.getBirthdays(filter)
  ...
  return (
    <div className="fade-in">
      <h1 className="text-xl font-bold mb-5">Cumpleañeros</h1>
      ...
      {loading ? <div className="flex justify-center py-16"><Spinner size={28} className="opacity-30" /></div>
        : birthdays.length === 0 ? (
          <EmptyState icon={CreditCard} title={
